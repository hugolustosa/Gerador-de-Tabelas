...
for i in combinacoes_df.index:
    ...
    QUANT_PAX = math.floor(min(combinacoes_df.loc[i]['CAPACIDADE_PAX'], PAYLOAD / combinacoes_df.loc[i]['PESO_PAX']))
...
data_custos = combinacoes_df['CUSTO_MISSAO']
...
# =============================================================================
# prob+= x1*7+x169*0+x43*5+x211*0+x85*4+x253*0+x127*2+x295*0>=75,  "demanda atendida PMLZ_1"
# prob+= x2*10+x170*0+x44*9+x212*0+x86*8+x254*0+x128*6+x296*0>=75,  "demanda atendida PMXL_1"
# prob+= x3*7+x171*17+x45*7+x213*16+x87*7+x255*16+x129*5+x297*13>=75,  "demanda atendida FPSO_ANGRA_DOS_REIS"
# prob+= x4*7+x172*16+x46*7+x214*16+x88*6+x256*15+x130*4+x298*11>=75,  "demanda atendida FPSO_ILHABELA"
# prob+= x5*9+x173*18+x47*9+x215*18+x89*8+x257*18+x131*6+x299*15>=75,  "demanda atendida FPSO_ITAGUAI"
# prob+= x6*9+x174*18+x48*8+x216*18+x90*8+x258*18+x132*6+x300*14>=75,  "demanda atendida FPSO_MANGARATIBA"
# prob+= x7*8+x175*17+x49*8+x217*17+x91*7+x259*17+x133*5+x301*13>=75,  "demanda atendida FPSO_MARICA"
# prob+= x8*8+x176*17+x50*8+x218*17+x92*8+x260*17+x134*6+x302*14>=75,  "demanda atendida FPSO_PARATY"
# prob+= x9*9+x177*18+x51*10+x219*18+x93*10+x261*18+x135*8+x303*18>=75,  "demanda atendida FPSO_PIONEIRO_DE_LIBRA"
# prob+= x10*11+x178*18+x52*11+x220*18+x94*11+x262*18+x136*9+x304*18>=75,  "demanda atendida FPSO_SANTOS"
# prob+= x11*7+x179*15+x53*6+x221*15+x95*6+x263*14+x137*4+x305*11>=75,  "demanda atendida FPSO_SAO_PAULO"
# prob+= x12*8+x180*17+x54*8+x222*17+x96*7+x264*16+x138*5+x306*13>=75,  "demanda atendida FPSO_SAQUAREMA"
# prob+= x13*10+x181*18+x55*10+x223*18+x97*10+x265*18+x139*8+x307*18>=87,  "demanda atendida NS_31"
# prob+= x14*10+x182*18+x56*10+x224*18+x98*10+x266*18+x140*8+x308*18>=87,  "demanda atendida NS_33"
# prob+= x15*10+x183*18+x57*10+x225*18+x99*10+x267*18+x141*8+x309*17>=87,  "demanda atendida NS_38"
# prob+= x16*10+x184*18+x58*10+x226*18+x100*10+x268*18+x142*8+x310*18>=87,  "demanda atendida NS_39"
# prob+= x17*10+x185*18+x59*10+x227*18+x101*10+x269*18+x143*8+x311*18>=87,  "demanda atendida NS_40"
# prob+= x18*9+x186*18+x60*9+x228*18+x102*9+x270*18+x144*7+x312*15>=87,  "demanda atendida NS_42"
# prob+= x19*9+x187*18+x61*9+x229*18+x103*8+x271*18+x145*6+x313*14>=87,  "demanda atendida NS_43"
# prob+= x20*9+x188*18+x62*9+x230*18+x104*9+x272*18+x146*7+x314*16>=87,  "demanda atendida NS_44"
# prob+= x21*7+x189*16+x63*7+x231*16+x105*7+x273*16+x147*5+x315*12>=87,  "demanda atendida P_66"
# prob+= x22*8+x190*18+x64*8+x232*18+x106*8+x274*17+x148*6+x316*14>=87,  "demanda atendida P_67"
# prob+= x23*9+x191*18+x65*9+x233*18+x107*9+x275*18+x149*7+x317*16>=87,  "demanda atendida P_68"
# prob+= x24*7+x192*16+x66*7+x234*16+x108*7+x276*15+x150*5+x318*12>=87,  "demanda atendida P_69"
# prob+= x25*9+x193*18+x67*9+x235*18+x109*9+x277*18+x151*7+x319*16>=87,  "demanda atendida P_70"
# prob+= x26*10+x194*18+x68*10+x236*18+x110*10+x278*18+x152*8+x320*18>=87,  "demanda atendida P_74"
# prob+= x27*9+x195*18+x69*10+x237*18+x111*10+x279*18+x153*8+x321*17>=87,  "demanda atendida P_75"
# prob+= x28*10+x196*18+x70*10+x238*18+x112*10+x280*18+x154*8+x322*17>=87,  "demanda atendida P_76"
# prob+= x29*10+x197*18+x71*10+x239*18+x113*10+x281*18+x155*8+x323*18>=87,  "demanda atendida P_77"
# prob+= x30*7+x198*16+x72*7+x240*16+x114*6+x282*15+x156*4+x324*12>=87,  "demanda atendida SS_75"
# prob+= x31*10+x199*18+x73*10+x241*18+x115*10+x283*18+x157*8+x325*18>=250,  "demanda atendida UMMA"
# prob+= x32*7+x200*16+x74*7+x242*16+x116*7+x284*16+x158*5+x326*12>=250,  "demanda atendida UMPA"
# prob+= x33*10+x201*18+x75*10+x243*18+x117*10+x285*18+x159*8+x327*17>=250,  "demanda atendida UMTJ"
# prob+= x34*11+x202*18+x76*11+x244*18+x118*11+x286*18+x160*9+x328*18>=250,  "demanda atendida UMVE"
# prob+= x35*10+x203*0+x77*10+x245*0+x119*10+x287*0+x161*8+x329*0>=30,  "demanda atendida SRIO"
# prob+= x36*8+x204*0+x78*8+x246*0+x120*8+x288*0+x162*6+x330*0>=30,  "demanda atendida SARU"
# prob+= x37*7+x205*0+x79*7+x247*0+x121*7+x289*0+x163*5+x331*0>=30,  "demanda atendida SAJA"
# prob+= x38*10+x206*0+x80*10+x248*0+x122*10+x290*0+x164*8+x332*0>=30,  "demanda atendida FASA"
# prob+= x39*7+x207*0+x81*7+x249*0+x123*7+x291*0+x165*5+x333*0>=30,  "demanda atendida SECR"
# prob+= x40*8+x208*0+x82*8+x250*0+x124*8+x292*0+x166*6+x334*0>=30,  "demanda atendida SAON"
# prob+= x41*8+x209*0+x83*8+x251*0+x125*8+x293*0+x167*6+x335*0>=30,  "demanda atendida SKST"
# prob+= x42*8+x210*0+x84*8+x252*0+x126*7+x294*0+x168*5+x336*0>=30,  "demanda atendida SKAU"
# =============================================================================
...
print('TOTAL VOOS MP = ', voos_MP_base1 + voos_MP_base2 + voos_MP_base3 + voos_MP_base4)
print('TOTAL VOOS GP = ', voos_GP_base1 + voos_GP_base2 + voos_GP_base3 + voos_GP_base4)
print('TOTAL VOOS = ', voos_MP_base1 + voos_MP_base2 + voos_MP_base3 + voos_MP_base4 + voos_GP_base1 + voos_GP_base2 + voos_GP_base3 + voos_GP_base4)
print('')
...
print('FROTA TOTAL MP = ', frota_MP_base1 + frota_MP_base2 + frota_MP_base3 + frota_MP_base4)
print('FROTA TOTAL GP = ', frota_GP_base1 + frota_GP_base2 + frota_GP_base3 + frota_GP_base4)
