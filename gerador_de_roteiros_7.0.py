...
msg_origem = "Escolha o aeroporto de origem"
msg_destino1 = "Escolha a UM 1."
msg_destino2 = "Escolha a UM 2. Caso não tenha uma 2ª UM repita a UM 1."
msg_destino3 = "Escolha a UM 3. Caso não tenha uma 3ª UM repita a UM 2."
msg_destino4 = "Escolha a UM 4. Caso não tenha uma 4ª UM repita a UM 3."
msg_destino_final = "Escolha o aeroporto final."


 
# opening a choice box using our msg and choices
origem = choicebox(msg_origem, choices = list(vertices_df.loc[vertices_df["TIPO"] == '1.BASE', "PONTO"]))
destino1 = choicebox(msg_destino1, choices = list(vertices_df.loc[vertices_df["TIPO"] == '3.UM', "PONTO"]))
destino2 = choicebox(msg_destino2, choices = list(vertices_df.loc[vertices_df["TIPO"] == '3.UM', "PONTO"]))
destino3 = choicebox(msg_destino3, choices = list(vertices_df.loc[vertices_df["TIPO"] == '3.UM', "PONTO"]))
destino4 = choicebox(msg_destino4, choices = list(vertices_df.loc[vertices_df["TIPO"] == '3.UM', "PONTO"]))
pouso_final = choicebox(msg_destino_final, choices = list(vertices_df.loc[vertices_df["TIPO"] == '1.BASE', "PONTO"]))
...
origem = origem.upper()
destino1 = destino1.upper()
destino2 = destino2.upper()
destino3 = destino3.upper()
destino4 = destino4.upper()
